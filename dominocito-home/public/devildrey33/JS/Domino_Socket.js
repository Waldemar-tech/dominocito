...
(function() {
 ...
 // 5. Si falló algo, hacer RESET FULL
 if (failed) {
 ...
 // Re-asignar valores usando el mapeo VISUAL correcto
 var poolIdx2 = 0;
 ...
 partida.FichaIzquierda = { Rama: 'izquierda', ValorLibre: function() { return null; } };
 partida.FichaDerecha = { Rama: 'derecha', ValorLibre: function() { return null; } };
 // Pre-asignar valores correctos a fichas de oponentes que jugaron
 ...
 if (preServerPos === myPosInServer) continue;
