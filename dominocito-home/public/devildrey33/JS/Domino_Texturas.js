...
var Domino_Texturas = function() {
    // Tamaño de los puntos (reducido para que no se vean más grandes de lo que son)
    this.TamPuntos = 45;
    ...
    this.Iniciar = function() {
        ...
        this.MaterialCara  = new THREE.MeshPhongMaterial({ color: 0xFFFFFF, specular : 0x222222, transparent : false, opacity:1.0, shininess : 15 });
